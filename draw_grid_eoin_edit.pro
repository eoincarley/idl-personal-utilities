;
pro draw_grid_eoin_edit,center,fov,item,img_siz=img_siz,img_pos=img_pos, 	$
  ...
  color=color,symcolor=symcolor,thick=thick,gridtype=gridtype,qstop=qstop,tv2=tv2, $
  nosavrest=nosavrest
;+
; NAME:
;       DRAW_GRID
...
if keyword_set(latlon) eq 1 then begin
  ...
  for i=0,npts_latlon-1 do oplot,[rtpc(1,i),rtpc(1,i)], $
				 [rtpc(2,i),rtpc(2,i)],psym=4, $
				 color=symcolor[i],thick=4,symsize=qsymsize[i]
endif
