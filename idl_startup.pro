...
DEFSYSV, '!c_light',		  299792458.0D0, 1     ;Speed of light in vacuum (m s^-1)
...
DEFSYSV, '!lightyear', 		  9.4605284D+15, 1     ;Light year (meters)
DEFSYSV, '!parsec',		   	 3.08567758D+16, 1     ;Parsec (meters)
DEFSYSV, '!1au', 				 1.4960D+11, 1	   ;Astronomical Unit (meters)
