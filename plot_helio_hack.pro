...
pro plot_helio_hack,date,grid_spacing=grid_spacing,glabel=glabel,_extra=extra,$
           ...
           xcor=xcor,ycor=ycor,tgrid=tgrid,inflate=inflate
...
;-- compute cartesian coordinates of grid points
 ...
 xy=hel2arcmin(lat,lon,date=tdate,_extra=extra)*60.0*inflate
